...
<body class="dark-theme">
    ...
    <script>
        ...
        function refresh_result() {
            ...
            var e4 = "**" + $("#enemy_unit_4").val() + "**";
            var hp4 = $("#enemy_hp_4").val() != "" ? separator + $("#enemy_hp_4").val() + "-**HP**"  : "";
            var a4 = $("#enemy_arti_4").val() != "" ? separator + "**" + $("#enemy_arti_4").val() + "**" : "";
            var s4 = $("#enemy_speed_4").text() != "—" ? separator + $("#enemy_speed_4").text() + "-**Speed**" : "";
            var i4 = $("#enemy_info_4").val() != "" ? separator + $("#enemy_info_4").val() : "";
